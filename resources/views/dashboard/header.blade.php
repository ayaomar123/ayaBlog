<div id="kt_header" class="header header-fixed">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="header-menu-wrapper header-menu-wrapper-left mt-3" id="kt_header_menu_wrapper">
            <!--begin::Header Menu-->
        ...
        <div class="topbar">
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item">
                            <a href="{{ url('/home/en') }}" class="navi-link">
                                ...
                                <span class="navi-text">{{ __('lang.en') }}</span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="navi-item active">
                            <a href="{{ url('/home/ar') }}" class="navi-link">
                                ...
                                <span class="navi-text">{{ __('lang.ar') }}</span>
                            </a>
                        </li>
                        <!--end::Item-->
                    </ul>
            ...
            <div id="kt_quick_user" class="myUser offcanvas offcanvas-right p-10">
                ...
                <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
                    <h3 class="font-weight-bold m-0">{{ __('lang.userProfile') }}</h3>
                ...
                <div class="offcanvas-content pr-5 mr-n5">
                    ...
                    <div class="d-flex align-items-center mt-5">
                        <div class="symbol symbol-100 mr-5">
                            <div class="symbol-label" style="background-image:url('../assets/media/users/usera.jpg')">
                            </div>
                    ...
                    <div class="navi navi-spacer-x-0 p-0">
                        ...
                        <!--begin::Item-->
                        <a href="{{ url('/editProfile') }}" class="navi-item">
                            <div class="navi-link">
                                ...
                                <div class="navi-text">
                                    <div class="font-weight-bold">{{ __('lang.myProfile') }}</div>
                                    <div class="text-muted">{{ __('lang.accountSetting') }}
                                        <span
                                            class="label label-light-danger label-inline font-weight-bold">{{ __('lang.update') }}</span>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="custom/apps/user/profile-3.html" class="navi-item">
                            <div class="navi-link">
                                ...
                                <div class="navi-text">
                                    <div class="font-weight-bold">{{ __('lang.myMsg') }}</div>
                                    <div class="text-muted">{{ __('lang.inboxtask') }}</div>
                                </div>
                            </div>
                        </a>
                        <!--end:Item-->
