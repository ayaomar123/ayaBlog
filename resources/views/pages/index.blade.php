                    ...
                    @foreach ($articles2 as $article2)
                        <div class="col-lg-4">
                            <div class="card-artical-a">
                                ...
                                <h1><a href="detials.html">مقالات قصيرة عن {{$article2->slug}}</a></h1>
                                <p>الحياة كيف تستمع بالحياة كيف تتخلى عن النمطية تعلم أن تحب الحياة ابحث عما يُسعدك
                                    الحياة اللغز الذي نبحث عن مكانه، الحياة ذاك الشيء البعيد...</p>
                            </div>
                        </div>
                    @endforeach
                </div>
                    ...
                    @foreach ($internationalArticles as $internationalArticle)
                        <div class="col-lg-4">
                            <div class="card-artical-a">
                                ...
                                <img src="../img/backpack.png" alt="">
                                <h1><a href="detials.html">مقالات قصيرة عن {{ $internationalArticle->slug }} </a></h1>
            ...
            <div class="col-lg-9 card-artical-a-parent ">
                <div class="row">
                    ...
                    <div class=" parent">
                        ...
                        <a href="department.html" class="a-parent"> <img src="../img/cookIcon.png" alt=""> الطبخ
                            والطعام</a>
                        <div class="col-lg-4">
                            <div class="card-artical-a department-card">
                                <div class="card-overlay-artical-a card-overlay-department-a">
                    ...
                    <div class=" parent">
                        ...
                        <a href="department.html" class="a-parent"> <img src="../img/game.png" alt=""> الألعاب
                            الإلكترونية</a>
                        <div class="col-lg-4">
                            <div class="card-artical-a department-card">
                                <div class="card-overlay-artical-a card-overlay-department-a">
                    ...
                    <div class=" parent">
                        ...
                        <a href="department.html" class="a-parent"> <img src="../img/leadership.png" alt=""> ريادة
                            الأعمال</a>
                        <div class="col-lg-4">
                            <div class="card-artical-a department-card">
                                <div class="card-overlay-artical-a card-overlay-department-a">
